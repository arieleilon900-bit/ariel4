...
> **עדכון:** לאתרי פרימיום יש עכשיו תבנית מלאה ונבדקת (מסע מצלמה בגלילה, בחירת אובייקט, bloom, fallback) ב-`premium-effects.md`, ודוגמה חיה ב-`clients/aven-residences/`. הקובץ הזה נשאר הרפרנס לאתרים הקלים.
